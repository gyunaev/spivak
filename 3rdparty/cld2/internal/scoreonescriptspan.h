...
typedef struct LangBoosts_s LangBoosts;
...
typedef struct ScoringContext_s ScoringContext;

struct ScoringContext_s {
...
typedef struct ScoringHitBuffer_s ScoringHitBuffer;

struct ScoringHitBuffer_s {
  ULScript ulscript;        // langprobs below are with respect to this script
